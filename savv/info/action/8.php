...
//$ti1="<h5 class=\"tt\">Вами выбран прием на ". date("d:m:Y",$nuw_date) ." в ". substr($time1,0,5) .". <br><br><br>Подтвердите ваш выбор</h5>";
...
{
var loc;
loc="rec_pos.php?action=2&inumber=<?php echo $inumber ?>&vopros=<?php echo $vopros ?>&kabinka=<?php echo $kabinka ?>&time1=<?php echo $time1 ?>&time2=<?php echo $time2 ?>&d1=<?php echo $d1 ?>&m1=<?php echo $m1 ?>&y1=<?php echo $y1 ?>";
